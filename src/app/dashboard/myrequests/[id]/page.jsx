...
const PetDetailsPage = async ({params}) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_SURVER_URL}/adoption-details/${id}`)
    const request = await res.json();
    console.log(request)

    const {_id, petName, species, breed, age, gender, imageUrl, healthStatus, vaccinationStatus, location, adoptionFee, Description, email} = request;
