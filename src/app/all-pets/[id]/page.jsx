...
const PetDetailsPage = async ({ params }) => {
    ...
    const { imageUrl, petName, species, breed, age, gender, healthStatus, vaccinationStatus, location, Description, email, adoptionFee } = pet
        ...
        <div className="max-w-7xl mx-auto my-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10">
                ...
                <div className="border rounded-2xl p-5">
                    <AdoptionForm pet={pet} user={session?.user}></AdoptionForm>
                </div>
            </div>
        </div>
    );
